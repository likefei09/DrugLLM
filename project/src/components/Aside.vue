...
default-openeds="['2']" style= "min-height :100%; overflow-x: hidden;"
...
<b style="color: white;" v-show="logoTextShow">DrugLLM管理平台</b>
</div>
<el-menu-item index="/home" style="margin: auto;">
